-- Add profile_completed field to customers table
ALTER TABLE public.customers 
ADD COLUMN profile_completed boolean NOT NULL DEFAULT false;

-- Update the handle_client_signup trigger to set profile_completed as false initially
...
BEGIN
    ...
    IF user_meta->>'user_type' = 'client' THEN
        ...
        -- Set profile_completed to false for new signups
