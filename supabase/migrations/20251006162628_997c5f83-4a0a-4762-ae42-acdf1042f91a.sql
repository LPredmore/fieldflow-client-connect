-- Fix type casting for clinician_field enum in handle_client_signup trigger
...
BEGIN
    ...
    ELSIF user_meta->>'user_type' = 'contractor' THEN
        ...
        -- Insert into clinicians with proper enum casting for clinician_field
        INSERT INTO public.clinicians (
            ...
            CASE 
                ...
                THEN ARRAY[(user_meta->>'clinician_field')::clinician_field]
                ELSE NULL
            END,
