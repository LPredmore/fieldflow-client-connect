-- Add clinician_license_number column to clinicians table
ALTER TABLE public.clinicians
ADD COLUMN IF NOT EXISTS clinician_license_number TEXT;

-- Update handle_client_signup trigger to process all clinician fields
...
BEGIN
    ...
    ELSIF user_meta->>'user_type' = 'contractor' THEN
        ...
        -- Insert into clinicians with all staff registration fields
