-- Fix handle_client_signup trigger to cast primary_state to us_states enum
...
BEGIN
    ...
    ELSIF user_meta->>'user_type' = 'contractor' THEN
        ...
        -- Insert into clinicians with proper enum casting for clinician_licensed_states
        INSERT INTO public.clinicians (
            ...
            -- Cast primary_state to us_states enum type
            CASE 
