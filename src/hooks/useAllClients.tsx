...
/**
 * Hook for fetching ALL clients within the tenant (admin-only use case).
 * Unlike useClients, this does NOT filter by primary_staff_id.
 */
export function useAllClients() {
  ...
  const {
    ...
    filters: {
      tenant_id: 'auto',
      // No primary_staff_id filter - fetch ALL clients for tenant
    },
    enabled: !!tenantId,
